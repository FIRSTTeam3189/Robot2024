...
class DriveXbox
    : public frc2::CommandHelper<frc2::Command, DriveXbox> {
 public:
  DriveXbox(frc2::CommandXboxController *controller, SwerveDrive *swerveDrive, DriveState driveState, units::degree_t arbitraryAngle = 0.0_deg);
