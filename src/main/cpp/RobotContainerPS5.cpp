...
RobotContainerPS5::RobotContainerPS5() {
  (void)VisionConstants::kSyncBytes[0];
  RegisterAutoCommands();
  
  // Initialize all of your commands and subsystems here 

  m_swerveDrive->SetDefaultCommand(DrivePS5(&m_bill, m_swerveDrive, m_driveState));
...
void RobotContainerPS5::ConfigureDriverBindings() {
  // Bill controls
  ...
  ampScoreIntakeButton.OnTrue(frc2::ParallelCommandGroup(
    ...
    DrivePS5(&m_bill, m_swerveDrive, DriveState::ArbitraryAngleAlign, SwerveDriveConstants::kAmpAlignTarget),
...
void RobotContainerPS5::ConfigureCoDriverBindings() {
  // Ted controls
  ...
  directShooterLoadButton.OnTrue(frc2::ParallelCommandGroup(
    DrivePS5(&m_bill, m_swerveDrive, DriveState::SourceAlign),
...
void RobotContainerPS5::RegisterAutoCommands() {
...
void RobotContainerPS5::CreateAutoPaths() {
...
frc2::Command* RobotContainerPS5::GetAutonomousCommand() {
  // An example command will be run in autonomous
  return m_chooser.GetSelected();
}

SuperstructureState RobotContainerPS5::GetSuperstructureState() {
  return m_superstructureState;
}

bool RobotContainerPS5::IsClimbState() {
...
void RobotContainerPS5::SetAllCoast() {
...
void RobotContainerPS5::SetAllNormalBrakeMode() {
...
BrakeMode RobotContainerPS5::GetBrakeMode() {
  return m_climber->GetBrakeMode();
}

void RobotContainerPS5::ConfigureTestBindings() {
